window.addEventListener('DOMContentLoaded', () => {
  ...
  //5. next addEv if(offset == int(width)*sl.len-1) offset 0 else offset += int(width) translateX${offset}
  //6. prev addEv if(offset == 0) offset int(width)*sl.len-1 else offset -= int(width) translateX${offset}
